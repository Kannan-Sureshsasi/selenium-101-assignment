...
public class TestScenario3EdgeCloud {
    ...
    public void setUp() {
        driver = TestMuDriverFactory.createDriver(
                ...
                "Windows 11",
                "latest",
                "Scenario 3 - Input Form Submit - Edge",
    ...
    public void inputFormSubmitTest() {
        ...
        System.out.println("EDGE CLOUD SCENARIO 3 STARTED");
        ...
        System.out.println("EDGE CLOUD SCENARIO 3 RESULT: PASSED");
    }
