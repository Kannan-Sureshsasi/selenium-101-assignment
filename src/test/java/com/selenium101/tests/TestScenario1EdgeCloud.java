...
public class TestScenario1EdgeCloud {
    ...
    public void setUp() {
        ...
        driver = TestMuDriverFactory.createDriver(
                ...
                "Windows 11",
                "latest",
                "Scenario 1 - Simple Form Demo - Edge",
    ...
    @Test
    public void simpleFormDemoEdgeCloudTest() {

        System.out.println("EDGE CLOUD SCENARIO 1 STARTED");
        ...
        System.out.println(
                "EDGE CLOUD SCENARIO 1 RESULT: PASSED"
        );
    }
